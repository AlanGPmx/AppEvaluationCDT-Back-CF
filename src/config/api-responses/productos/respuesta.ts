...
export const RESPUESTA_PRODUCTO = {
  status: CODIGO_200,
  schema: {
    properties: {
      codigo: { type: 'string', example: '200.AppEvaluation-CDT' },
      ...
      resultado: {
        ...
        example: {
          ...
          withDiscount: null,
          description:
            'Con tu consola Xbox Series tendrás entretenimiento asegurado todos los días. Su tecnología fue creada para poner nuevos retos tanto a jugadores principiantes como expertos. \r\n\r\nLa nueva generación de consolas está comandada por la Xbox Series que llegó al mercado para sorprender a todos. Su potencia y alto rendimiento te permitirá reducir las horas de descarga de juegos y contenido de manera considerable en comparación con otras consolas. Además, vas a poder jugar durante horas mientras te diviertes con jugadores de todo el mundo.\r\n\r\nAdaptada a tus necesidades\r\nGuarda tus apps, fotos, videos y mucho más en el disco duro, que cuenta con una capacidad de 1 TB. \r\nAl contar con un procesador de 8 núcleos y uno gráfico, brinda una experiencia dinámica, respuestas ágiles, y transiciones fluidas de imágenes en alta definición.\r\nPor otro lado, tiene puerto USB y salida HDMI, que permiten conectar accesorios y cargar la batería de tu control mientras juegas.\r\n\r\nVas a poder reproducir música, ver tus películas y series favoritas a través de las aplicaciones descargables. ',
          categoryId: 1,
          stock: 0,
          img: 'https://http2.mlstatic.com/D_Q_NP_2X_850214-MLA45046473101_032021-R.jpg',
          path: 'https://http2.mlstatic.com/D_Q_NP_2X_850214-MLA45046473101_032021-R.jpg',
          options: null,
        },
      },
    },
...
export const RESPUESTA_PRODUCTOS_MAS_VENDIDOS = {
  status: CODIGO_200,
  schema: {
    properties: {
      codigo: { type: 'string', example: '200.AppEvaluation-CDT' },
          ...
          productos: [
            {
              ...
              stock: 999,
              img: 'https://http2.mlstatic.com/D_Q_NP_2X_771415-MLA44492818319_012021-AB.jpg',
              path: 'https://http2.mlstatic.com/D_Q_NP_2X_771415-MLA44492818319_012021-AB.jpg',
              options: '["512 GB", "1 TB"]',
            },
            {
              id: 3,
            ...
            {
              id: 4,
              name: 'Smart TV Onn. 100012589 LED HD 32" 100V/240V',
              price: 3999,
              withDiscount: 3450.01,
              description:
                'Con el Smart TV 100012589 accederás a las aplicaciones donde se encuentran tus contenidos favoritos. Además, podrás navegar por Internet, interactuar en redes sociales y divertirte con videojuegos.\r\n\r\nSumérgete en la pantalla\r\nSu resolución HD te presentará imágenes con gran detalle y alta definición. Ahora todo lo que veas cobrará vida con brillo y colores más reales.',
              categoryId: 2,
              stock: 67,
              img: 'https://http2.mlstatic.com/D_Q_NP_2X_869347-MLA44226115511_122020-R.jpg',
              path: 'https://http2.mlstatic.com/D_Q_NP_2X_869347-MLA44226115511_122020-R.jpg',
              options: null,
            },
          ],
        },
